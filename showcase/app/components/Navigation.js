...
function Navigation() {
  ...
  return (
    <div class="flex h-16 p-10 items-center justify-between overflow-hidden border-lightGray border-b-2 bg-gray">
      <div className="flex items-center justify-between">
        ...
        <h1 className="font-interRegular tracking-wider text-sm text-lightYellow md:text-lg">Showcase</h1>
      </div>
